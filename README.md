...
The zine (`css/news.css`) is a digital Y2K newspaper on Home news + `/news` — Newsreader broadsheet, Oswald gothic kickers, polaroids. Evening-edition house gossip: the floor, the fit, the after.
