...
export default function LightBeams() {
  ...
  return (
    <group>
      <AdditiveQuad u={0.88} v={0.4} w={5.5} h={14} tex={beam} base={0.08} flickerSpeed={0.7} flickerAmount={0.04} color="#ffc070" />
      <AdditiveQuad u={0.72} v={0.38} w={6} h={15} tex={beam} base={0.07} flickerSpeed={0.5} flickerAmount={0.03} color="#ffb860" />
      <AdditiveQuad u={0.54} v={0.42} w={5} h={12} tex={beam} base={0.075} flickerSpeed={0.9} flickerAmount={0.04} color="#ffcf8a" />
      <AdditiveQuad u={0.22} v={0.4} w={5.5} h={13} tex={beam} base={0.07} flickerSpeed={0.6} flickerAmount={0.03} color="#ffc070" />
    </group>
  );
}
