...
export default function LightBeams() {
  ...
  return (
    <group>
      <AdditiveQuad u={0.574} v={0.38} w={5.5} h={14} tex={beam} base={0.08} flickerSpeed={0.7} flickerAmount={0.04} color="#ffc070" />
      <AdditiveQuad u={0.486} v={0.36} w={6} h={15} tex={beam} base={0.07} flickerSpeed={0.5} flickerAmount={0.03} color="#ffb860" />
      <AdditiveQuad u={0.395} v={0.38} w={5} h={12} tex={beam} base={0.075} flickerSpeed={0.9} flickerAmount={0.04} color="#ffcf8a" />
      <AdditiveQuad u={0.128} v={0.45} w={5.5} h={13} tex={beam} base={0.07} flickerSpeed={0.6} flickerAmount={0.03} color="#ffc070" />
    </group>
  );
}
