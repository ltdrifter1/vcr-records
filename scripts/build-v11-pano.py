#!/usr/bin/env python3
"""
V11 panorama production bake — LISTEN tower on the far back wall; Shop tightly on the cash register.

Input : art/vcr-pano-v11-src.png  (1536x1024 cel painting: nearly square open
...
Output: public/textures/store_pano_v11.webp        4096x2048 lights-on
        public/textures/store_pano_off_v11.webp    4096x2048 lights-off grade
        public/textures/store_pano_lqip_v11.webp   512x256 preview
...
Run: python3 scripts/build-v11-pano.py
"""
...
SRC = ROOT / "art" / "vcr-pano-v11-src.png"
OUT_ON = ROOT / "public" / "textures" / "store_pano_v11.webp"
OUT_OFF = ROOT / "public" / "textures" / "store_pano_off_v11.webp"
OUT_LQIP = ROOT / "public" / "textures" / "store_pano_lqip_v11.webp"
