#!/usr/bin/env python3
"""
V10 panorama production bake — LISTEN tower relocated to the counter/door wall.

Input : art/vcr-pano-v10-src.png  (1536x1024 cel painting: nearly square open
        room, wide oak floor with a moss rug, sage wainscot, cream walls,
        blue-grey door, charcoal fixtures, terracotta pots — premium PNW)
Output: public/textures/store_pano_v10.webp        4096x2048 lights-on
        public/textures/store_pano_off_v10.webp    4096x2048 lights-off grade
        public/textures/store_pano_lqip_v10.webp   512x256 preview
...
Run: python3 scripts/build-v9-pano.py
"""
...
SRC = ROOT / "art" / "vcr-pano-v10-src.png"
OUT_ON = ROOT / "public" / "textures" / "store_pano_v10.webp"
OUT_OFF = ROOT / "public" / "textures" / "store_pano_off_v10.webp"
OUT_LQIP = ROOT / "public" / "textures" / "store_pano_lqip_v10.webp"
...
TOY_SPRITES = {
    "stool": (0.198, 0.412, 8.0, 10.0, "dark"),  # headphones on relocated LISTEN
...
# Background color sample points (source-px of the 1536x1024 painting):
# cream walls, sage wainscot, counter/cabinet wood, oak floor, moss rug.
BG_POINTS = (
    (1250, 360),
    (60, 350),
    (940, 470),
